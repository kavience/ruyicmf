...
class AppStoreController extends AppStoreAdminBaseController
{
    ...
    public function apps()
    {
        ...
        $url         = "https://www.ruyicmf.com/api/appstore/apps?token={$accessToken}&page=" . $currentPage;
    ...
    public function plugins()
    {
        ...
        $currentPage = $this->request->param('page', 1, 'intval');
        $url         = "https://www.ruyicmf.com/api/appstore/plugins?token={$accessToken}&page=" . $currentPage;
        $data        = cmf_curl_get($url);
    ...
    public function themes()
    {
        ...
        $currentPage = $this->request->param('page', 1, 'intval');
        $url         = "https://www.ruyicmf.com/api/appstore/themes?token={$accessToken}&page=" . $currentPage;
        $data        = cmf_curl_get($url);
    ...
    public function doLogin()
    {
        ...
        $data = cmf_curl_get("https://www.ruyicmf.com/api/appstore/login/refreshAccessToken?access_token={$accessToken}&domain=$domain");
    ...
    public function installPlugin()
    {
        ...
        $data    = cmf_curl_get("https://www.ruyicmf.com/api/appstore/plugins/{$id}?token=$accessToken&version=$version");
        $data    = json_decode($data, true);
    ...
    public function installApp()
    {
        ...
        $id      = $this->request->param('id', 0, 'intval');
        $version = $this->request->param('version', '', 'urlencode');
        $data    = cmf_curl_get("https://www.ruyicmf.com/api/appstore/apps/{$id}?token=$accessToken&version=$version");
        $data    = json_decode($data, true);
    ...
    public function installTheme()
    {
        ...
        $id      = $this->request->param('id', 0, 'intval');
        $version = $this->request->param('version', '', 'urlencode');
        $data    = cmf_curl_get("https://www.ruyicmf.com/api/appstore/themes/{$id}?token=$accessToken&version=$version");
        $data    = json_decode($data, true);
